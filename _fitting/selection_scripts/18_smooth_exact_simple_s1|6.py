...
fitting_task = '18_smooth_exact_(2.5,5)_greedy_1'
...
selected_complete_simple = {
    ...
    't2m_max_pop_weighted(4)': [(1.0, 5)], # from (2.5, 10), # from (1.0, 15) weird edge basis function shape
    't2m_max_pop_weighted(5)': [(1.0, 5)], # from (2.5, 10), # from (1.0, 15)
    ...
    't2m_mean_pop_weighted(1)': [(1.0, 5)], # from (2.5, 30)
    't2m_mean_pop_weighted(2)': [(1.0, 5)], # from (2.5, 30) 
...
# selected_complete_simple = {s:[(1.0, 10)] for s in statistics}
...
#1
#s1 = 'tp_24hmean_pop_weighted_log(1)'
#2
#s1 = 'rh_mean_pop_weighted(0)'
#3
# s1 = 'rh_mean_pop_weighted(1)'

# statistics.remove(s1)
